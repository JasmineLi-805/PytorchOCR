...
config.train_options = {
    # for train
    'resume_from': '/Users/jasmineli/Desktop/PytorchOCR/output/CRNN/checkpoint/latest.pth',  # 继续训练地址
...
config.dataset = {
    'alphabet': r'/Users/jasmineli/Desktop/PytorchOCR/ccpd-data/dictionary.txt',
    'train': {
        'dataset': {
            'type': 'RecTextLineDataset',
            'file': r'/Users/jasmineli/Desktop/PytorchOCR/ccpd-data/train.txt',
            'input_h': 32,
            'mean': 0.5,
            'std': 0.5,
            'augmentation': False,
    ...
    'eval': {
        'dataset': {
            'type': 'RecTextLineDataset',
            'file': r'/Users/jasmineli/Desktop/PytorchOCR/ccpd-data/val.txt',
            'input_h': 32,
            'mean': 0.5,
            'std': 0.5,
            'augmentation': False,
